            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="text-left flex flex-col w-full md:w-1/2 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-4 mt-8">
                        ...
                        <a href="/assest/Santhoshkumar Resume.pdf" download className="px-6 py-3 bg-transparent border-2 border-blue-600 hover:bg-blue-600 text-blue-600 hover:text-white font-medium rounded-lg transition duration-300 shadow-md hover:shadow-lg flex items-center">
